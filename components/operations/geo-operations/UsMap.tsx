...
import type { GeoStateStatus } from "@/lib/operations/geo-operations/types";
import { US_MAP_PATHS, US_MAP_VIEWBOX } from "@/lib/operations/geo-operations";

interface UsMapProps {
  states: Record<string, GeoOperationsState>;
...
const STATUS_EMOJI: Record<GeoStateStatus, string> = {
  live: "🟢",
  under_review: "🟡",
  disabled: "🔴",
};
  ...
  return (
    <div className={`geo-map-wrap ${className}`}>
      ...
      <svg
        ...
        role="img"
        aria-label="Interactive United States geo operations map"
      >
        <defs>
          <filter id="geo-ops-state-glow" x="-50%" y="-50%" width="200%" height="200%">
          ...
          <linearGradient id="geo-ops-map-vignette" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="rgba(99,102,241,0.08)" />
            <stop offset="100%" stopColor="rgba(59,130,246,0.04)" />
          </linearGradient>
        </defs>

        <rect x="0" y="0" width="680" height="560" fill="url(#geo-ops-map-vignette)" rx="12" />
